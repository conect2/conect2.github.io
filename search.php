       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>BÚSQUEDA DE PRODUCTOS <small class="tittles-pages-logo">CONECT</small></h1>
            </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  <?php
                    ...
                    $consultar_productos=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM articulo WHERE nombre LIKE '%".$search."%' OR Modelo LIKE '%".$search."%' OR Marca LIKE '%".$search."%' LIMIT $inicio, $regpagina");
            ...
            <?php
                  ...
                  echo '<h2 class="text-center">Por favor escriba el nombre o marca del articulo que desea buscar</h2>';
              }
            ?>
        </div>
    </section>
