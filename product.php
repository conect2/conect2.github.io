       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">CONECT2</small></h1>
            </div>
            <?php
                      ...
                      <ul class="dropdown-menu" aria-labelledby="drpdowncategory">
                        <?php 
                          while($cate=mysqli_fetch_array($checkAllCat, MYSQLI_ASSOC)){
                              echo '
                                <li><a href="product.php?categ='.$cate['idcategoria'].'">'.$cate['nombre'].'</a></li>
                    ...
                    <form action="./search.php" method="GET">
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" id="addon1" class="form-control" name="term" required="" title="Escriba nombre o marca del articulo">
            ...
            ?>
              <div class="row">
                <?php
                  ...
                  $consultar_productos=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM articulo WHERE idcategoria='$categoria' AND stock > 0 AND Estado='Activo' LIMIT $inicio, $regpagina");

                  $selCat=ejecutarSQL::consultar("SELECT * FROM categoria WHERE idcategoria='$categoria'");
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                         <div class="thumbnail">
                           ...
                           <div class="caption">
                             ...
                             <?php endif; ?>
                             <p class="text-center">
                                 <a href="infoProd.php?codigo=<?php echo $prod['codigo']; ?>" class="btn btn-primary btn-raised btn-sm btn-block"><i class="fa fa-plus"></i>&nbsp; Detalles</a>
                             </p>
