...
<body id="container-page-index">
    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo">CONECT2</small></h1>
            </div>
            <br><br><br>
            <div class="row">
                        ...
                        <div class="row">
                          <div class="col-xs-10 col-xs-offset-1">
                            ...
                            <p class="text-center">
                              ...
                              <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal" data-target="#PagoModalpm">Pago Movil</button>
                              <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal" data-target="#PagoModalbnc">Metamask</button>
                              <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal" data-target="#PagoModalmtm">Binance Play</button>
                            </p>
                          </div>
                        </div>
                      </div>
        ...
        <?php
            if($_SESSION['UserType']=="User"){
                $consultaC=ejecutarSQL::consultar("SELECT * FROM ventaonline WHERE NIT='".$_SESSION['UserNIT']."'");
        ?>
    ...
    <!-- PagoMovil-->
    <div class="modal fade" id="PagoModalpm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <form class="modal-content FormCatElec" action="process/confirmcompra.php" method="POST" role="form" data-form="save">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Pago por Pago movil</h4>
          </div>
          <div class="modal-body">
            ...
            <p>
              ...
              <strong>Numero de Telefono:</strong> <?php echo $datBank['Numerodetelefono']; ?><br>
              <strong>Cedula del beneficiario:</strong> <?php echo $datBank['CeduladelBeneficiario']; ?><br>
            </p>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="tipo-envio" data-toggle="tooltip" data-placement="top" title="Elige El Tipo De Envio">
                      ...
                      <option value="Envio Por Currier">Envio </option> 
                  </select>
               </div>
                <div class="form-group">
                    <label>Identificaion del cliente</label>
...
<!-- PagoMovil-->
<!-- Metamask-->
    <div class="modal fade" id="PagoModalbnc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <form class="modal-content FormCatElec" action="process/confirmcompra.php" method="POST" role="form" data-form="save">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">Pago por Metamask </h4>
          </div>
          <div class="modal-body">
            <?php
              $consult1=ejecutarSQL::consultar("SELECT * FROM cuentabanco");
            ...
            <p>Por favor haga el deposito en la siguiente cuenta de banco e ingrese el numero de deposito que se le proporciono.</p><br>
            <p>
              <strong>Token:</strong> <?php echo $datBank['token']; ?><br>
              <strong>Direccion:</strong> <?php echo $datBank['mtm']; ?><br>
            </p>
                <?php if($_SESSION['UserType']=="Admin"): ?>
                <div class="form-group">
                    <label>Numero de deposito</label>
