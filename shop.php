...
<body id="container-page-index">
    ...
    <section id="new-prod-index">    
         <div class="container">
            ...
            <div class="row">
                  ...
                  $consulta= ejecutarSQL::consultar("SELECT * FROM articulo WHERE stock > 0 AND Estado='Activo' ORDER BY idarticulo DESC LIMIT 7");
                     ...
                     <div class="thumbnail">
                       ...
                       <div class="caption">
                            ...
                            <?php if($fila['Descuento']>0): ?>
                             ...
                             <?php endif; ?>
                        <p class="text-center">
                            <a href="infoProd.php?codigo=<?php echo $fila['codigo']; ?>" class="btn btn-primary btn-sm btn-raised btn-block"><i class="fa fa-plus"></i>&nbsp; Detalles</a>
                        </p>
                       </div>
                     </div>
                </div>     
    ...
    <section idcategoria="reg-info-index">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">CONECT2</span> en un sencillo formulario para poder completar tus pedidos</p>
