    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">CONECT2</small></h1>
            </div>
            <p class="lead text-center">
            "Soy Luis Vargas, el fundador de Conect2, tu tienda online donde encontrarás todo lo que necesitas, desde los últimos gadgets hasta los outfits más trendy. 
            En Conect2, creemos en la calidad, la innovación y la satisfacción del cliente. ¡Conectados contigo!
            </p>
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/fundador.jpg" alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
